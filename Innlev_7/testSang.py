...
"""
sang1 = Sang("hello","Lionel Richard")
print(sang1.spill())
print(sang1.sjekkArtist("Lionel richard"))
print(sang1.sjekkTittel("Hello"))
print(sang1.sjekkArtistogTittel("Lionel Richard", "Hello"))
"""
